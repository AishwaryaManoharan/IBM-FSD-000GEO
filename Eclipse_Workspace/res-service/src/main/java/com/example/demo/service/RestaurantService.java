...
public class RestaurantService {
	...
	public RestaurantDto updateRestaurant(RestaurantDto restaurantDetail, String resId) {
		...
		if (restaurant.isPresent()) {
			...
			tempRestaurant.setCo_ordinates(restaurantDetail.getCo_ordinates());
			tempRestaurant.setImage(restaurantDetail.getImage());
			tempRestaurant.setLocation(restaurantDetail.getLocation());
...
//			}
	...
	// Display by name
		...
		public List<Restaurant> findByAnyCriteria(String criteria)
		{
			 List<Restaurant> restaurantList = restaurantRepository.findAllByLocationContainingOrNameContaining(criteria,criteria);
