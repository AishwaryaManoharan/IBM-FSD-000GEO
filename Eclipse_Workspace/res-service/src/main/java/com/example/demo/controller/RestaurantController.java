...
public class RestaurantController {
	...
	public ResponseModel createRestaurant(@RequestBody RequestModel restaurantDetail) {
	...
	public ResponseModel updateRestaurant(@RequestBody RequestModel restaurantDetail,
	...
	public ResponseModel deleteRestaurant(@PathVariable("id") String resID) {
		ModelMapper mapper = new ModelMapper();
	...
	// display by any criteria 
	@CrossOrigin
	@GetMapping("restaurant/findBy/{criteria}")
	public List<Restaurant> findByAnyCriteria(@PathVariable("criteria") String criteria)
	{
		return service.findByAnyCriteria(criteria);
	}
